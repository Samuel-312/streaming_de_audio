<template>
  <div class="playlist-view">
    ...
    <div v-else-if="playlist">
      ...
      <div class="playlist-header">
        ...
        <div class="playlist-info">
          ...
          <div class="header-buttons">
            ...
            <!-- Solo el dueño puede agregar canciones -->
            <button
              v-if="isOwner"
      ...
      <div class="songs-list">
        ...
        >
          ...
          <!-- Botón quitar solo si es el dueño -->
    ...
    <!-- Modal confirmar quitar canción -->
...
// Canciones de la playlist ordenadas por posición
const songs = computed(() => {
  if (!playlist.value?.playlist_songs) return []
  return [...playlist.value.playlist_songs].sort((a, b) => a.position - b.position)
})

// Verifica si el usuario logueado es el dueño de la playlist
const isOwner = computed(() => {
  return playlist.value?.owner_id === authStore.user?.id
})

// Estado del modal de agregar canciones
const showAddModal = ref(false)
const allSongs = ref([])         // Todas las canciones del sistema
const loadingAllSongs = ref(false)
const searchQuery = ref('')
const addingSongId = ref(null)   // ID de la canción que se está agregando

// Filtra canciones según el texto buscado
...
async function openAddSongsModal() {
  ...
  // Solo cargamos las canciones si no las tenemos ya
